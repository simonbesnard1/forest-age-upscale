...
Intermediate_stand_replaced_class = AgeDiffPartition_fraction_1deg.stand_replaced_class_partition.where(forest_fraction >0.2).sel(age_class = ['20-80']).sum(dim='age_class')
Intermediate_stand_replaced_class = Intermediate_stand_replaced_class.where(Intermediate_stand_replaced_class >0)

Mature_stand_replaced_class =  AgeDiffPartition_fraction_1deg.stand_replaced_class_partition.where(forest_fraction >0.2).sel(age_class = ['80-200']).sum(dim='age_class')
