...
Young_stand_replaced_class =  (BiomassDiffPartition_1deg.stand_replaced.sel(age_class= '0-20') * 0.47) 
Intermediate_stand_replaced_class = (BiomassDiffPartition_1deg.stand_replaced.sel(age_class= '20-80') * 0.47) 
Mature_stand_replaced_class =   (BiomassDiffPartition_1deg.stand_replaced.sel(age_class= '80-200') * 0.47)
OG_stand_replaced_class =   (BiomassDiffPartition_1deg.stand_replaced.sel(age_class= '>200')* 0.47)
...
ax[1,1].text(0.05, 1.05, 'd', transform=ax[1,1].transAxes,
            fontsize=16, fontweight='bold', va='top')
plt.savefig(os.path.join(plot_dir,'figS9.png'), dpi=300)
