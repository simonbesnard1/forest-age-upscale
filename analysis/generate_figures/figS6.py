...
pixel_area = (width_of_longitude * height_of_latitude *
              np.cos(np.deg2rad(Intermediate_stand_replaced_class.latitude))).broadcast_like(Intermediate_stand_replaced_class)
...
plt.savefig('/home/simon/Documents/science/research_paper/global_age_Cdyn/figs/figS6.png', dpi=300)
