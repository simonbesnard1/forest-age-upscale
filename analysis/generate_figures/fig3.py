...
Young_stand_replaced_class =  AgeDiffPartition_fraction_1deg.stand_replaced_class_partition.where(forest_fraction >0.2).sel(age_class = '0-20')
Young_stand_replaced_class = Young_stand_replaced_class.where(Young_stand_replaced_class >0)

Intermediate_stand_replaced_class = AgeDiffPartition_fraction_1deg.stand_replaced_class_partition.where(forest_fraction >0.2).sel(age_class = '20-80')
Intermediate_stand_replaced_class = Intermediate_stand_replaced_class.where(Intermediate_stand_replaced_class >0)

Mature_stand_replaced_class =  AgeDiffPartition_fraction_1deg.stand_replaced_class_partition.where(forest_fraction >0.2).sel(age_class = '80-200')
Mature_stand_replaced_class = Mature_stand_replaced_class.where(Mature_stand_replaced_class >0)

OG_stand_replaced_class = AgeDiffPartition_fraction_1deg.stand_replaced_class_partition.where(forest_fraction >0.2).sel(age_class = '>200')
OG_stand_replaced_class = OG_stand_replaced_class.where(OG_stand_replaced_class >0)

Young_aging_class =  AgeDiffPartition_fraction_1deg.aging_forest_class_partition.where(forest_fraction >0.2).sel(age_class = '0-20')
Young_aging_class = Young_aging_class.where(Young_aging_class >0)

Intermediate_aging_class = AgeDiffPartition_fraction_1deg.aging_forest_class_partition.where(forest_fraction >0.2).sel(age_class = '20-80')
Intermediate_aging_class = Intermediate_aging_class.where(Intermediate_aging_class >0)

Mature_aging_class =  AgeDiffPartition_fraction_1deg.aging_forest_class_partition.where(forest_fraction >0.2).sel(age_class = '80-200')
Mature_aging_class = Mature_aging_class.where(Mature_aging_class >0)

OG_aging_class = AgeDiffPartition_fraction_1deg.aging_forest_class_partition.where(forest_fraction >0.2).sel(age_class = '>200')
...
ax[0].text(0.01, 1.05, '(a)', transform=ax[0].transAxes, fontsize=16, fontweight='bold', va='top')
