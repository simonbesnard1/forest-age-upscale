...
Young_stand_aging_class =  (BiomassDiffPartition_1deg.gradually_ageing.where(forest_fraction >0.2).sel(age_class= '0-20') * 0.47 ) 
Intermediate_stand_aging_class = (BiomassDiffPartition_1deg.gradually_ageing.where(forest_fraction >0.2).sel(age_class= '20-80') * 0.47 ) 
Mature_stand_aging_class =   (BiomassDiffPartition_1deg.gradually_ageing.where(forest_fraction >0.2).sel(age_class= '80-200') * 0.47)
OG_stand_aging_class =   (BiomassDiffPartition_1deg.gradually_ageing.where(forest_fraction >0.2).sel(age_class= '>200')* 0.47)
...
ax[0,0].coastlines()
ax[0,0].gridlines()
ax[0,0].set_title('Undisturbed ageing young forests \n (1-20 years)')
...
ax[0,1].coastlines()
ax[0,1].gridlines()
ax[0,1].set_title('Undisturbed ageing maturing forests \n (21-80 years)')
...
ax[1,0].coastlines()
ax[1,0].gridlines()
ax[1,0].set_title('Undisturbed ageing mature forests \n (81-200 years)')
...
ax[1,1].coastlines()
ax[1,1].gridlines()
ax[1,1].set_title('Undisturbed ageing old-growth forests \n ($>$200 years)')
ax[1,1].text(0.01, 1.15, '(d)', transform=ax[1,1].transAxes,
            fontsize=16, fontweight='bold', va='top')
plt.savefig(os.path.join(plot_dir,'figExt7.png'), dpi=300)
