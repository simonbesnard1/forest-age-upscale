...
#SBATCH --output=/home/besnard/projects/forest-age-upscale/scripts/management_partition/log/batch_management_calc_%j.out
#SBATCH --error=/home/besnard/projects/forest-age-upscale/scripts/management_partition/log/batch_management_calc_%j.err
...
TOTAL_JOBS=5202
MAX_JOBS_PER_BATCH=900

# Path to the SLURM submission script
JOB_SCRIPT="/home/besnard/projects/forest-age-upscale/scripts/management_partition/managementType_calc.sh"
...
for (( i=0; i<TOTAL_JOBS; i+=MAX_JOBS_PER_BATCH )); do
    ...
    sed "s/#SBATCH --array=.*/#SBATCH --array=$i-$END%50/" "$JOB_SCRIPT" > "$TEMP_SCRIPT"
