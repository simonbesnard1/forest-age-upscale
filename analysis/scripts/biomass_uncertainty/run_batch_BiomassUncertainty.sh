...
#SBATCH --output=/home/besnard/projects/forest-age-upscale/scripts/biomass_uncertainty/log/batch_BiomassUncertainty_calc_%j.out
#SBATCH --error=/home/besnard/projects/forest-age-upscale/scripts/biomass_uncertainty/log/batch_BiomassUncertainty_calc_%j.err
...
JOB_SCRIPT="/home/besnard/projects/forest-age-upscale/scripts/biomass_uncertainty/CCI-AGB100m_members_cubegen.sh"
...
for (( i=0; i<TOTAL_JOBS; i+=MAX_JOBS_PER_BATCH )); do
    ...
    sed "s/#SBATCH --array=.*/#SBATCH --array=$i-$END%25/" "$JOB_SCRIPT" > "$TEMP_SCRIPT"
