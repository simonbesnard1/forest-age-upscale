...
class ManagementType(ABC):
    ...
    def __init__(self,
        ...
        self.management_cube = xr.open_zarr(self.config_file['ForestManagement_cube'], synchronizer=self.sync_feature).isel(time=0).drop('time')
    ...
    def _calc_func(self, 
        ...
        subset_management_cube = self.management_cube.sel(IN)[[self.config_file['management_var']]]
