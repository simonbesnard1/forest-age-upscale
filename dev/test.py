...
for age_class, current_points in current_points_per_class.items():
    ...
    if required_samples > 0:
        ...
        balanced_data_OG = pd.concat([balanced_data_OG, oversampled_data])
    else:
        balanced_data_OG = pd.concat([balanced_data_OG, non_OG[non_OG['age_class'] == age_class]])
